...
LdrCannotCreateTemp=Nu pot crea o fișierul temporar. Instalarea a fost întreruptă
LdrCannotExecTemp=Nu pot executa un fișier din dosarul temporar. Instalarea a fost întreruptă
HelpTextNote=
...
ErrorTooManyFilesInDir=Nu pot crea un fișier în dosarul "%1" din cauză că are deja prea multe fișiere
...
; *** Common wizard text
ClickNext=Dă clic pe Continuă pentru a avansa cu instalarea sau pe Anulează pentru a o abandona.
BeveledLabel=
BrowseDialogTitle=Explorare după Dosar
BrowseDialogLabel=Selectează un dosar din lista de mai jos, apoi dă clic pe OK.
...
PasswordLabel3=Completează parola, apoi dă clic pe Continuă pentru a merge mai departe. Tipul literelor din parolă (Majuscule/minuscule) este luat în considerare.
...
InfoBeforeClickLabel=Cînd eşti gata de a trece la Instalare, dă clic pe Continuă.
WizardInfoAfter=Informaţii
InfoAfterLabel=Citeşte informaţiile următoare înainte de a continua, sînt importante.
InfoAfterClickLabel=Cînd eşti gata de a trece la Instalare, dă clic pe Continuă.
...
SelectDirBrowseLabel=Pentru a avansa cu instalarea, dă clic pe Continuă. Dacă vrei să selectezi un alt dosar, dă clic pe Explorează.
...
SelectComponentsLabel2=Selectează componentele de instalat; deselectează componentele care nu trebuie instalate. Dă clic pe Continuă pentru a merge mai departe.
...
SelectTasksLabel2=Selectează sarcinile suplimentare care trebuie îndeplinite în timpul instalării [name], apoi dă clic pe Continuă.
...
SelectStartMenuFolderBrowseLabel=Pentru a avansa cu instalarea, dă clic pe Continuă. Dacă vrei să selectezi un alt dosar, dă clic pe Explorează.
...
ReadyLabel2a=Dă clic pe Instalează pentru a continua cu instalarea, sau dă clic pe Înapoi dacă vrei să revezi sau să schimbi setările.
ReadyLabel2b=Dă clic pe Instalează pentru a continua cu instalarea.
...
ClickFinish=Dă clic pe Finalizează pentru a părăsi Instalatorul.
...
SelectDiskLabel2=Introdu Discul %1 şi dă clic pe OK.%n%nDacă filele de pe acest disc pot fi găsite într-un alt dosar decît cel afişat mai jos, introdu calea corectă sau dă clic pe Explorează.
PathLabel=&Cale:
