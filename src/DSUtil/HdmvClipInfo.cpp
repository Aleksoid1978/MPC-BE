...
HRESULT CHdmvClipInfo::ReadInfo(LPCTSTR strFile, SyncPoints* sps/* = nullprt*/)
{
...
HRESULT CHdmvClipInfo::FindMainMovie(LPCTSTR strFolder, CString& strPlaylistFile, CPlaylist& MainPlaylist, CPlaylist& Playlists)
{
	HRESULT hr = E_FAIL;
