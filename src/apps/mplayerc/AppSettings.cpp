...
#define ADDCMD(cmd) wmcmds.emplace_back(wmcmd##cmd)
	...
	ADDCMD((ID_FILE_OPENDIRECTORY,				  0, FVIRTKEY|FNOINVERT,				IDS_AG_OPEN_DIR));
	...
	ADDCMD((ID_MENU_SUBTITLELANG,				'S', FVIRTKEY|FALT|FNOINVERT,			IDS_AG_MENU_SUBTITLELANG));
	ADDCMD((ID_MENU_AUDIOLANG,					'A', FVIRTKEY|FALT|FNOINVERT,			IDS_AG_MENU_AUDIOLANG));
	ADDCMD((ID_MENU_JUMPTO,						'G', FVIRTKEY|FALT|FNOINVERT,			IDS_AG_MENU_JUMPTO));
	...
	ADDCMD((ID_PLAY_SEEKFORWARDSMALL,			  0, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_FORWARD_1));
	ADDCMD((ID_PLAY_SEEKBACKWARDSMALL,			  0, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_BACKWARD_1));
	ADDCMD((ID_PLAY_SEEKFORWARDMED,		   VK_RIGHT, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_FORWARD_2));
	ADDCMD((ID_PLAY_SEEKBACKWARDMED,		VK_LEFT, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_BACKWARD_2));
	ADDCMD((ID_PLAY_SEEKFORWARDLARGE,			  0, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_FORWARD_3));
	ADDCMD((ID_PLAY_SEEKBACKWARDLARGE,			  0, FVIRTKEY|FNOINVERT,				IDS_AG_JUMP_BACKWARD_3));
	ADDCMD((ID_PLAY_SEEKKEYFORWARD,		   VK_RIGHT, FVIRTKEY|FSHIFT|FNOINVERT,			IDS_AG_JUMP_FORWARD_K));
	ADDCMD((ID_PLAY_SEEKKEYBACKWARD,		VK_LEFT, FVIRTKEY|FSHIFT|FNOINVERT,			IDS_AG_JUMP_BACKWARD_K));
	...
	ADDCMD((ID_PLAY_REPEAT_AB,					  0, FVIRTKEY|FNOINVERT,				IDS_PLAYLOOPMODE_AB));
	ADDCMD((ID_PLAY_REPEAT_AB_MARK_A,	   VK_OEM_4, FVIRTKEY|FNOINVERT,				IDS_PLAYLOOPMODE_AB_MARK_A));
	ADDCMD((ID_PLAY_REPEAT_AB_MARK_B,	   VK_OEM_6, FVIRTKEY|FNOINVERT,				IDS_PLAYLOOPMODE_AB_MARK_B));
	...
	ADDCMD((ID_MENU_FAVORITES,					  0, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_FAVORITES));
	...
	ADDCMD((ID_VIEW_FULLSCREEN_2,		  VK_RETURN, FVIRTKEY|FALT|FNOINVERT,			IDS_AG_FULLSCREEN_2));
	...
	ADDCMD((ID_PANSCAN_ROTATE_CCW,		 VK_NUMPAD1, FVIRTKEY|FALT|FNOINVERT,			IDS_AG_PNS_ROTATE_CCW));
	ADDCMD((ID_PANSCAN_ROTATE_CW,		 VK_NUMPAD3, FVIRTKEY|FALT|FNOINVERT,			IDS_AG_PNS_ROTATE_CW));
	...
	ADDCMD((ID_MENU_PLAYER_LONG,			VK_APPS, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_PLAYER_L, 0, wmcmd::RUP, wmcmd::RUP));
	ADDCMD((ID_MENU_PLAYER_SHORT,				  0, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_PLAYER_S));
	ADDCMD((ID_MENU_FILTERS,					  0, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_FILTERS));
	...
	ADDCMD((ID_SUB_DELAY_DEC,				  VK_F1, FVIRTKEY|FNOINVERT,				IDS_AG_SUBDELAY_DEC));
	ADDCMD((ID_SUB_DELAY_INC,				  VK_F2, FVIRTKEY|FNOINVERT,				IDS_AG_SUBDELAY_INC));

	ADDCMD((ID_MENU_AFTERPLAYBACK,				  0, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_AFTERPLAYBACK));
