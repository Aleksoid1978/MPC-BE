...
#define ADDCMD(cmd) wmcmds.emplace_back(wmcmd##cmd)
	...
	ADDCMD((ID_PLAY_REPEAT_AB_CLEAR_A,  IDS_PLAYLOOPMODE_AB_CLEAR_A, VK_OEM_4, FSHIFT));
	ADDCMD((ID_PLAY_REPEAT_AB_CLEAR_B,  IDS_PLAYLOOPMODE_AB_CLEAR_B, VK_OEM_6, FSHIFT));
