...
#define ADDCMD(cmd) wmcmds.emplace_back(wmcmd##cmd)
	...
	ADDCMD((ID_MENU_PLAYER_SHORT,			VK_APPS, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_PLAYER_S, 0, wmcmd::RUP, wmcmd::RUP));
	ADDCMD((ID_MENU_PLAYER_LONG,				  0, FVIRTKEY|FNOINVERT,				IDS_AG_MENU_PLAYER_L));
