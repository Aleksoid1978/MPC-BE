...
#define ADDCMD(cmd) wmcmds.emplace_back(wmcmd##cmd)
	ADDCMD((ID_FILE_OPENQUICK,			IDS_MPLAYERC_0,				'Q', FCONTROL));
	ADDCMD((ID_FILE_OPENMEDIA,			IDS_AG_OPEN_FILE,			'O', FCONTROL));
	...
	ADDCMD((ID_PANSCAN_MOVEDOWNRIGHT,	IDS_MPLAYERC_59,			VK_NUMPAD3, FCONTROL));
	...
	ADDCMD((ID_STREAM_SUB_ONOFF,		IDS_MPLAYERC_85,			'W'));
	ADDCMD((ID_SUBTITLES_RELOAD,		IDS_MPLAYERC_86));
	// subtitle position
