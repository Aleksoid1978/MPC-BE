...
static filter_t s_filters[] = {
	...
	// DXVA decoder
	{L"H264/AVC (DXVA)",			DXVA_DECODER,  VDEC_DXVA_H264,		0},
	{L"HEVC (DXVA)",				DXVA_DECODER,  VDEC_DXVA_HEVC,		0},
	{L"MPEG-2 Video (DXVA)",		DXVA_DECODER,  VDEC_DXVA_MPEG2,		0},
	{L"VC-1 (DXVA)",				DXVA_DECODER,  VDEC_DXVA_VC1,		0},
	{L"WMV3 (DXVA)",				DXVA_DECODER,  VDEC_DXVA_WMV3,		0},
	{L"VP9 (DXVA)",					DXVA_DECODER,  VDEC_DXVA_VP9,		0},
